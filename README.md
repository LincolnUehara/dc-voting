...
![Gif do funcionamento](https://github.com/LincolnUehara/dc-voting/blob/master/git-images/func_rede.gif)
...
```
git clone https://Lin-hara@bitbucket.org/Lin-hara/dc-voting.git
cd dc-voting
chmod +x install.sh
sudo ./install.sh
```
